    ...
    return (  
        <Layout className="layout">
            ...
            >
                ...
                { isAuth ? <Menu.Item key="2"><Link to='/'>Home</Link></Menu.Item> : null }
                ...
                { isAuth ? <Menu.Item><Link to='/student/add'>Add Student</Link></Menu.Item> : null }
                { isAuth ? <Menu.Item><Link to='/about'>About</Link></Menu.Item> : null }
